    ...
    <AuthLayout>
      <GlowCard className="p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link href="/forgot-password" className="text-xs text-terminal hover:text-terminal/80 transition-colors">
                Forgot password?
              </Link>
            </div>
            <div className="relative">
        ...
        <p className="mt-8 text-center text-sm text-muted-foreground">
          ...
          <Link href="/register" className="text-terminal hover:text-terminal/80 font-medium transition-colors">
            Create one
          </Link>
        </p>
      </GlowCard>
